...
export function LoadingUnloadingWorksNsm() {
  return (
    <Space
      direction="vertical"
      size="small">
      ...
      />
      <Typography.Title level={1}>Погрузочно-разгрузочные работы НСМ</Typography.Title>
      <Typography.Title level={3}>Погрузочно-разгрузочные работы НСМ</Typography.Title>
      <Row gutter={[20, 20]}>
        <Col
          sm={24}
          md={18}>
